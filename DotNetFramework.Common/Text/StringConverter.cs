...
namespace DotNetFramework.Common.Text
{
    /// <summary>
    /// 
    /// </summary>
    public static class StringConverter
    {
        ...
        /// <returns></returns>
        public static string ChineseCharactersToPinYin(string content)
        {
            string r = string.Empty;

            foreach (char item in content)
            {
                r += string.Format("{0} ", ChineseCharactersToPinYin(item));
            }
            return r;
        }
        ...
        /// <param name="content"></param>
        /// <returns></returns>
        public static string ChineseCharactersToPinYin(char content)
        {
            string r = string.Empty;

            try
            {
                ChineseChar chineseChar = new ChineseChar(content);
        ...
        //public static string CoverterToSimplified(string traditionalStr)
        //{
        //    return Strings.StrConv(traditionalStr, VbStrConv.SimplifiedChinese, 0);

        //}

        //public static string CoverterToTraditional(string simplifiedStr)
        //{
        //    return Strings.StrConv(simplifiedStr, VbStrConv.TraditionalChinese, 0);
        //}
